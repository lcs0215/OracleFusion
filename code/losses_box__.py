...
class SDSLoss(nn.Module):
    def __init__(self, cfg, device, control):
        ...
        self.cfg = cfg
        self.device = device
        self.pipe = StableDiffusionPipeline.from_pretrained('/data/diffusion/sd-controlnet-scribble/models/stable-diffusion-v1-5',
    ...
    def forward(self, x_aug):
        ...
        if self.cfg.bbox != None:
            ...
            with torch.autocast(device_type="cuda", dtype=torch.float16):
                noise_pred_text = self.pipe.unet(noised_latent_zt, timestep,
                                            encoder_hidden_states=self.text_embeddings[1].unsqueeze(0), 
